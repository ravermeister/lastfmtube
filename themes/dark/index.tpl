...
<link rel="stylesheet"
	href="//unpkg.com/purecss@1.0.0/build/pure-min.css" type="text/css" />
<!--[if lte IE 8]>
		    <link rel="stylesheet" href="//unpkg.com/purecss@1.0.0/build/grids-responsive-old-ie-min.css" type="text/css" />
		<![endif]-->
<!--[if gt IE 8]><!-->
<link rel="stylesheet"
	href="//unpkg.com/purecss@1.0.0/build/grids-responsive-min.css"
	type="text/css" />
<!--<![endif]-->
<!--// purecss.io //-->
...
<link rel="stylesheet"
	href="{$BASE_PATH}/themes/dark/css/jquery.contextmenu.css"
	type="text/css" />
<link rel="stylesheet" href="{$BASE_PATH}/themes/dark/css/styles.css"
	type="text/css" />


<script
	src="//cdnjs.cloudflare.com/ajax/libs/iframe-resizer/3.6.1/iframeResizer.contentWindow.min.js"></script>

<script src="{$BASE_PATH}/js/messageResource.min.js"></script>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async="async"
	src="//www.googletagmanager.com/gtag/js?id=UA-26904270-14"></script>
...
<script
	src="//cdnjs.cloudflare.com/ajax/libs/hazzik-jquery.livequery/1.3.6/jquery.livequery.min.js"></script>
...
<body>
	...
	<a href="//github.com/ravermeister/lastfmtube" target="_blank"> <img
		style="position: absolute; top: 0; left: 0; border: 0;"
		src="//camo.githubusercontent.com/c6625ac1f3ee0a12250227cf83ce904423abf351/68747470733a2f2f73332e616d617a6f6e6177732e636f6d2f6769746875622f726962626f6e732f666f726b6d655f6c6566745f677261795f3664366436642e706e67"
		alt="Fork me on GitHub" />
	</a>


	<h2 style="text-align: center;">
		<a href="//www.last.fm/user/{$lastfm_user}" id="lastfm_user_title_url"
			target="_blank"> <span id="lastfm_user_title">{$lastfm_user}</span></a>'s
		{$LANG['site.header.lastfmuser.suffix']}
	</h2>
	...
	<div>
		...
		<div id="hotkeys_view">
			<span> Strg+&larr; = previous Track | Strg+&rarr; = next Track
				| Strg+Enter = play/pause<br /> + = Vol. up | - = Vol. down |
	...
	<div class="playercontrol">
		<div class="lastfmuser">
			...
			{$LANG['site.playercontrol.user.label']} <input type="text"
				value="{$lastfm_user}" id="lastfm_user" /> <input type="button"
		...
		<div class="pages">
			...
			{$LANG['site.pagecontrol.page']} <input type="text" id="pagefield"
				value="{$current_page}" size="1" maxlength="5" />
			{$LANG['site.pagecontrol.page.of']} <span
				id="lastfm_user_pages_total">{$total_pages}</span> <input
				type="button" id="pageload" value="{$LANG['site.pagecontrol.load']}" />
	...
	<div class="playlist-menu pure-menu pure-menu-horizontal">
		<ul class="pure-menu-list">
			<li class="pure-menu-item"><a class="pure-menu-link"
				id="topuser_title" title="{$LANG['site.tooltip.hideshow']}">+
					{$LANG['topuser.title']}</a></li>
			<li class="pure-menu-item"><a class="pure-menu-link"
				id="playlist-title" title="{$LANG['site.tooltip.hideshow']}">-
					{$LANG['playlist.title']}</a></li>
			<li class="pure-menu-item"><a class="pure-menu-link"
				id="charts_title" title="{$LANG['site.tooltip.hideshow']}">+
					{$LANG['charts.title']}</a></li>
			<li class="pure-menu-item"><a class="pure-menu-link"
				id="user_title" title="{$LANG['site.tooltip.hideshow']}">+
					{$LANG['userplaylist.title']}</a></li>
		</ul>
	</div>

	<div class="playlist-container">
		<div class="playlist-main">
			<div id="topuser_list" class="topusers cmenu_topuser">in this
				box, the Top Last.fm user will be shown</div>

			<div class="playlist">{include file='./playlist.tpl'}</div>

			<div id="charts_list" class="charts cmenu_charts">in this box,
				the Top Songs will appear</div>
		</div>

		<div class="playlist-sidebar">
			<div id="user_list" class="userlist cmenu_user">in this box,
				the custom playlist will appear</div>
		</div>
