    ...
    <form action="admin.php" method="post">
        <table>
            ...
            <tr>
                ...
                <td style="width:20px;">&nbsp;</td>
                <td style="vertical-align: top;">
                    Width: <input type="text" value="{$SETTINGS['general']['playerwidth']}" name="general_playerwidth"
                                  size="4"/>
                    &nbsp;&nbsp;
                    Height: <input type="text" value="{$SETTINGS['general']['playerheight']}"
                                   name="general_playerheight" size="4"/>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="height:20px">&nbsp;</td>
            ...
            <tr>
                ...
                <td style="width:20px;">&nbsp;</td>
                <td style="vertical-align: top;">
                    <input type="text" value="{$SETTINGS['general']['lastfm_defaultuser']}"
